package com.malaikamedical.controller;
...
import com.malaikamedical.service.Mservice;
@Controller
@RequestMapping("/")
public class PatientRegistrationController extends BaseController<PatientRegistration> {
	@Autowired(required = true)
	@Qualifier(value = "studentServiceImpl")
	private Mservice<PatientRegistration> pt;
	
	//get form
		@GetMapping(value = "/")
		@Override
			public ModelAndView getForm(ModelAndView md) {
			 md.addObject("patient",new PatientRegistration());
